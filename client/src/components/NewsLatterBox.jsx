  ...
  return (
    ...
    >
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black ">
        Send details to get premium packages
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-body-color">
        We are here for you service 24/7 subscribe to get more exciting features.
      </p>
      <form>
        <input
          type="text"
          ...
          className="mb-4 w-full rounded-md  py-3 px-6 text-base font-medium  placeholder-body-color outline-none border-b-0  focus-visible:shadow-none dark:bg-[#f5f6fd] dark:shadow-signUp "
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Send"
          className="duration-80 mb-4 w-full cursor-pointer rounded-md border border-transparent bg-primary py-3 px-6 text-center text-base font-medium bg-sky-700 text-white outline-none transition ease-in-out hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
        />
      ...
      <div className="absolute top-0 left-0 z-[-1] ">
        ...
        >
          <mask
            ...
            height="596"
          >
            <rect width="370" height="596" rx="2" fill="red" />
          </mask>
