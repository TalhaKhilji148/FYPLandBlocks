...
useEffect(() => {
  console.log("Property Edit >>>>>",blogEdit);
}, [blogEdit]);
  ...
  const handleBlog = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/blogs/update/${blogEdit}`,
        {
      ...
      if (response.status === 200) {
        ...
        console.log("BlogDataa", responseData);
        setShowForm(false);
    ...
    <div className="flex w-full justify-center  items-center 2xl:px-20">
      <div className="flex flex-col md:p-12 px-4">
        {blogsData && blogsData.length > 0 ? (
          <h3 className="text-black text-3xl text-center my-2">My Blogs</h3>
        ) : (
        ...
        <div className="flex flex-wrap justify-center items-centre mt-20 mb-40">
          {blogsData
            ...
            .map((item, i) => (
              <div className="bg-[#e5e3e3] m-4    2xl:min-w-[480px] 2xl:max-w-[600px] sm:min-w-[470px] sm:max-w-[300px] flex-col p-3 rounded-md hover:shadow-2xl">
                <div className=" w-full mt-3">
                  <div className="  p-2 flex ml-5">
                    ...
                    <div className="ml-10 h-16">
                      ...
                      <p className="text-black text-base font-body ">
                        <span className="font-bold">Authorinfo:</span>{" "}
                        {item.authorinfo}
                      </p>
                      ...
                      <p className="text-black text-base w-60 font-body">
                        ...
                        {item?.desc ? item.desc.substring(0, 100) : ""} eth
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-row ml-72  h-10">
                    ...
                    {!showMobileNav && showForm && (
                      ...
                      >
                        ...
                        >
                          <h2 className="text-xl mb-10">Update Blog</h2>
