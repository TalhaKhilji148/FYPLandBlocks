  ...
  return (
    <div className={classes.container}>
      <div>
        ...
        <div className="h-40 pt-10 bg-white">
          <h1 className="text-3xl font-bold  align-middle text-center mt-20 text-blue-900">
            Join LandBlocks as a Company!
          </h1>
        </div>
        <img
          className={classes.logo}
          src={require("../../../assets/companyImage.jpg")}
          alt="horse"
        />
      </div>
      <div className={classes.wrapper}>
        <h3 className=" text-center mb-5">
          Wanna Join as a Seller?{" "}
          <Link className="text-sky-600 ml-3 mt-[-1px]" to="/signin">
            SignUp
          </Link>
        </h3>
        <Typography
        ...
        <form onSubmit={handleRegister}>
          ...
          <p className="text-blue-950 flex-row ">
            ...
            <Link className="text-[#0369a1] ml-3 mt-[-1px]" to="/logincompany">
              Login
            </Link>
          </p>
          <button
