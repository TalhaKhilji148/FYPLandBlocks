...
import NewsLatterBox from "../ContactCompany/NewsLatterBoxCompany";
...
const BlogDetailsPage = () => {
 ...
 useEffect(() => {
   const fetchDetails = async () => {
     try {
       console.log("innnnnn");
       const data = await request(`/blogs/detail/${id}`, "GET");
       setBlogDetail(data);
              ...
              <div>
                    ...
                    <div className="mr-10 mb-5 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <img
                            src={blogDetail?.currentOwner?.profileImg}
                            alt="author"
                            fill
                          />
                        </div>
                      ...
                      <div className="w-full">
                        <h4 className="mb-1 text-base font-medium text-body-color">
                          By
                          <span> {blogDetail?.currentOwner?.username}</span>
                        </h4>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center">
                      <p className="mr-5 flex items-center text-base font-medium text-body-color">
                        ...
                        {blogDetail?.createdAt
                          ? blogDetail.createdAt.substring(0, 10)
                          : ""}
                      </p>
                      <p className="mr-5 flex items-center text-base font-medium text-body-color">
                        <span className="mr-3">
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    This Blog is about the Idea of{" "}
                    <a href={blogDetail?.link}>
                      <span className="font-bold text-blue-500">
                        {blogDetail?.technology}
                      </span>
                    </a>
                  </p>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    <br />
                    {blogDetail?.desc.split(".").map((paragraph, index) => (
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary mt-[-170px] bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      Landblocks represent a revolutionary paradigm in real
                      estate, offering a decentralized and transparent approach
                      to property ownership and transactions. By leveraging
                      blockchain technology, landblocks introduce a secure and
                      immutable ledger system that ensures trust and
                      accountability in the world of real estate.
                    </p>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Blogger email : {blogDetail?.currentOwner?.email}
                  </p>
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text={blogDetail?.category} />
                        <TagButton text={blogDetail?.technology} />
                        ...
                        <TagButton
                          text={
                            blogDetail?.updatedAt
                              ? blogDetail.updatedAt.substring(0, 10)
                              : ""
                          }
                        />
                      </div>
            ...
            <div className="w-full px-4 lg:w-4/12">
              <div className="mb-10 rounded-md bg-primary bg-opacity-5">
                ...
                <ul className="p-8">
                  <li className="mb-6 border-b border-body-color border-opacity-10 pb-6  ">
                    <RelatedPost
                      title={`Introduction to  ${blogDetail?.technology} for better understanding`}
                  ...
                  <li className="mb-6 border-b border-body-color border-opacity-10 pb-6  ">
                    <RelatedPost
                      title={`Why ${blogDetail?.technology} is necessary?`}
                      image="https://desikaanoon.in/wp-content/uploads/2022/08/istockphoto-1253922154-612x612-1.jpg"
                      slug="#"
                      date="15 Feb, 2023"
                    />
                  </li>
                  <li>
                    <RelatedPost
                      title={`what about some other information related to ${blogDetail?.technology} ?`}
                      image="https://cdn5.vectorstock.com/i/1000x1000/89/99/graphic-cartoon-character-blog-vector-37638999.jpg"
                      slug="#"
                      date="05 Jun, 2021"
                    />
                  </li>
              ...
              <div className="mb-10 rounded-md bg-primary bg-opacity-5">
                ...
                <div className="flex flex-wrap py-6 px-8">
                  <TagButton text="IPFS" />
                  <TagButton text="Transaction" />
                  <TagButton text="Three.js" />
