              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="mr-6 text-[#1f2a64] hover:text-primary"
                  >
                    <svg
                      width="9"
                      height="18"
                  ...
                  <a
                    href="/"
                    aria-label="social-link"
                    className="mr-6 text-[#9ca4e1] hover:text-primary"
                  >
                    <svg
                      width="19"
                      height="14"
                  ...
                  <a
                    href="/"
                    aria-label="social-link"
                    className="mr-6 text-[#fe564d] hover:text-primary"
                  >
                    <svg
                      width="18"
                      height="14"
                  ...
                  <a
                    href="/"
                    aria-label="social-link"
                    className="mr-6 text-[#5867dd] hover:text-primary"
                  >
                    <svg
                      width="17"
                      height="16"
