  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-body-color  ">
        LandBlock is here for your service 24/7, avail this offer to get more features
      </p>
      <form>
        <input
          type="text"
          ...
          className="mb-4 w-full rounded-md bg-slate-100 border-0 border-body-color border-opacity-10 py-3 px-6 text-base font-medium text-body-color placeholder-body-color outline-none focus:border-primary focus:border-opacity-100 focus-visible:shadow-none  "
        />
        <input
          type="email"
          name="email"
          placeholder="Enter your email"
          className="mb-4 w-full border-0 rounded-md bg-slate-100 border border-body-color border-opacity-10 py-3 px-6 text-base font-medium text-body-color placeholder-body-color outline-none focus:border-primary focus:border-opacity-100 focus-visible:shadow-none  "
        />
        <input
          type="submit"
          value="Send"
...
export default NewsLatterBoxCompany;
