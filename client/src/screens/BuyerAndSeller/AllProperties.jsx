...
import classes from "../BuyerAndSeller/featuredProperties/featuredProperties.module.css";
  ...
  return (
    <div>
      <div className={classes.container}>
        <div className="text-center font-medium mt-[-60px] mb-5 text-4xl  ">
                ...
                <div className={classes.featuredProperty} key={property._id}>
                  ...
                  <div className={classes.details}>
                    <div className={classes.priceAndOwner}>
                      <span className=" mr-3 font-bold">{property?.title}</span>
                      <span className="ml-20 w-15  font-bold">
                        {property?.price} eth
                      </span>
