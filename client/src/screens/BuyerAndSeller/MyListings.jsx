...
const handleFileChange = (event) => {
  ...
  //   const PropertyCard = ({ price, continent, beds, img, _id }) => {
  ...
  useEffect(() => {
    ...
    const fetchTokenized = async () => {
      try {
        const data = await request("/property/reserved", "GET");
    ...
    <div className="flex w-full justify-center  items-center 2xl:px-20">
      <div className="flex flex-col md:p-12 px-4">
        {featuredProperties && featuredProperties.length > 0 ? (
          <h3 className="text-black text-3xl text-center my-2">My Listings</h3>
        ) : (
          <h3 className="text-black text-3xl mt-32 text-center my-2 text-red-600">
              ...
              <div className="bg-[#fdfbfb] m-4    2xl:min-w-[480px] 2xl:max-w-[600px] sm:min-w-[470px] sm:max-w-[300px] flex-col p-3 rounded-md hover:shadow-2xl">
                <div className=" w-full mt-3">
                  <div className="  p-2 flex ml-5">
                    <Link to={`/propertyDetailsSeller/${item._id}`}>
                      <img
                    ...
                    <div className="ml-10 h-16">
                      ...
                      <p className="text-black text-base font-body ">
                        <span className="font-bold">Baths:</span> {item.baths}
                      </p>
                      <p className="text-black text-base font-body ">
                      ...
                      <p className="text-black text-base w-60 font-body">
                        ...
                        <span className="ml-1"> </span> {item.address} eth
                      </p>
                    </div>
                  </div>
        ...
        <div>
          {tokenizedProperties && tokenizedProperties.length > 0 ? (
            <h3 className="text-black text-3xl mt-[-200px] text-center my-2">
              My Tokenized Properties
            </h3>
          ) : (
            <h3 className="text-black text-3xl mt-[-200px] text-center my-2 text-red-600">
              You don't have any listings yet!
            </h3>
          )}
          <div className="flex flex-wrap justify-center items-centre mt-20 mb-40">
            {/* .filter((myitem) => myitem?.currentOwner.username === "talha") */}
            {tokenizedProperties
              .filter((myitem) => myitem?.user?._id === id)
              .map((item, i) => (
                <div className="bg-[#fdfbfb] m-4    2xl:min-w-[480px] 2xl:max-w-[600px] sm:min-w-[470px] sm:max-w-[300px] flex-col p-3 rounded-md hover:shadow-2xl">
                  <div className=" w-full mt-3">
                    <div className="  p-2 flex ml-5">
                      <Link
                        to={`/propertyDetailsSeller/${item?.property?._id}`}
                      >
                        <img
                          className="w-64  rounded-lg h-60"
                          src={item?.property?.img}
                        ></img>
                      </Link>
                      ...
                      <div className="ml-10 h-16">
                        ...
                        <p className="text-black text-base w-40 font-body">
                          ...
                          {item.property?.price.toFixed(6)} eth
                        </p>
                        <p className="text-black text-base w-40 font-body">
                    ...
                    <div className="flex flex-row ml-72  h-10">
                      <Link
                        ...
                        className="  bg-sky-700 w-32 rounded-lg text-white"
                      >
                        <div className="flex flex-row ml-12 mt-2 h-10">
                          Edit
                        </div>
                      </Link>
                      {!showMobileNav && showForm && (
                      ...
                      <button
                        onClick={() => {
                          setClicked(!clicked);
                          fetch(
                            `http://localhost:5000/property/reserved/${item._id}`,
                            {
                              method: "DELETE",
                            }
                          )
